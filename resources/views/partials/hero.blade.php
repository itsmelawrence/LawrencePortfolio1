<div id="top" class="main-container">
    <div class="center-text">
        ...
        <div class="navigation-row fade-out-container">
            @if(config('portfolio.available_for_work'))
            <li class="nav-text availability-badge">
            ...
            <li class="nav-text">
                <a class="book-call-link" data-cal-link="lawrence-tendenilla-my4blt/15min" data-cal-config='{"layout":"month_view"}'>
                    Book a Call
                </a>
            </li>
        </div>
