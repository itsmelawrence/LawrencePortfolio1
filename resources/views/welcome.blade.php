       ...
       <div id="top" class="main-container">
                    ...
                    <span class="scroll-down-t scroll-down-arrow">&#8595</span>
                        ...
                        <script>
                            ...
                            function runEaseUpAnimation() {
                                ...
                                y: 0, 
                                stagger: 0.3,
                                ease: "power2.out"  // Ease-up effect
                                });
                            }
        ...
        <div id="about" class="about">
            <div class="info-holder">
                ...
                <div class="right-info-holder">
                    ...
                    <span class="desc-text">such</span>
                    <span class="desc-text">as</span>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                // Initialize all elements with the tooltip attribute
        ...
        <script>
            ...
            // Select all lyrics sections and animate words in each section
            document.querySelectorAll('.right-info-holder').forEach((section) => {
            const words = section.querySelectorAll('.desc-text');  // Select all words in the section

            // Calculate the number of words in each section
            const totalWords = words.length;

            // Create a ScrollMagic scene
            new ScrollMagic.Scene({
                triggerElement: section,    // Trigger when the section enters the viewport
                triggerHook: .8,           // Trigger halfway through the viewport
                duration: '50%',           // Duration of the effect (100% of section height)
            })
            .on("progress", (event) => {
                // Calculate the scroll percentage based on the scroll position
                const scrollProgress = event.progress;

                // Highlight words based on scroll progress
                words.forEach((word, index) => {
                const wordProgress = (index + 1) / totalWords;  // Get the progress of each word

                // If scroll progress is greater than the word's progress, highlight it
                if (scrollProgress >= wordProgress) {
                    gsap.to(word, {
                    opacity: 1,  // Make word visible
        ...
        <script>
            ...
            // GSAP ScrollTrigger animation to fade out text
            gsap.to(".fade-out-container", {
                opacity: 0,         // Fade the text out
                stagger: 0.8, 
                duration: 1,
                scrollTrigger: {
                    trigger: ".fade-out-container",  // Element that triggers the scroll effect
                    start: "top 10%",   // Start fading when the top of the element is at 80% of the viewport height
                    end: "top 50%",     // End fading when the top of the element reaches 30% of the viewport height
                    scrub: 1,           // Smoothly scrub the animation as you scroll
                    markers: false,      // You can set to true to visualize the trigger points
                }
            }); 
        </script>
            ...
            function scrollToHash(hash, e) {
                ...
                if (elem) {
                    ...
                    gsap.to(window, {
                        scrollTo: elem,
                        duration: 2.5,
                        ease: "power2.out" // ← Bezier-like easing
                    });
                }
            }
